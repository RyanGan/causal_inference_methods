...
- In the example, we want to know the average effect of a binary treatment for HIV (A) on continous CD4 counts (Y). Treatment is administered at multiple time points, with the only other covariate being a binary cutoff of HIV viral load (Z), where Z = 1 for viral load > 200 copies/ml. Further, viral load influences the decision to treat at that time point.   
