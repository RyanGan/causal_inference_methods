...
We get pretty much the same result using the g-formula approach to a standard regression. However, we've now made our "what if?" question explicit and testable. 

## Counterfactual Estimate using IPTW
Another commonly use method is the inverse-probability-of-treatment weight.
